...
workflow {
    ...
    knownsites = params.knownsites ? Channel.fromPath(params.knownsites.class == String ? params.knownsites.split(',') as List : params.knownsites_indexes).collect() : Channel.value([])
    knownsites_indexes = params.knownsites_indexes ? Channel.fromPath(params.knownsites_indexes.class == String ? params.knownsites_indexes.split(',') as List : params.knownsites_indexes).collect() : Channel.value([])
